...
$username = $_GET['username'];
$sql1 = "SELECT id,username,timest,content FROM BLOG";
...
volunteer_id VARCHAR(3))*/
            while($row = mysqli_fetch_array($result)){
                ...
                echo "<td style='font-size=13px'>" . $username1 . "</td>";
                echo "<br/>";
                echo "<td style='font-size=14px'>" . $row['timest'] . "</td><br/>";
                echo "<br/>";
                echo "<td style='font-size=13px'>" . $row['content'] . "</td>";
                echo "<td><a href='http://localhost/review_blogs1.php?username=$username&username1=$username1&id=$i'><button>Edit</button></a></td>";
                echo "<td><a href='http://localhost/delete_blog.php?username=$username&id=$i'><button>Delete</button></a></td></tr>";
        }
