...
$str = "";
$sql1 = "SELECT name,username,emailid,hierarchy FROM user";
...
volunteer_id VARCHAR(3))*/
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                elseif($hierarchy == 2)
                  $str = "Publisher";
                echo "<td style='font-size=13px'>" . $str . "</td>";
                $username = $_GET['username'];
                echo "<td><a href='http://localhost/review_user.php?username=$username&username1=$username1'><button>Review</button></a></td>";
        }
